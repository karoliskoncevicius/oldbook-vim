...
if &t_Co >= 256
  ...
  set background=dark
  hi Normal           ctermbg=238  ctermfg=255  cterm=NONE        guibg=#3c4c55 guifg=#ebeae9 gui=NONE
  ...
  hi Identifier       ctermbg=NONE ctermfg=101  cterm=NONE        guibg=NONE    guifg=#999183 gui=NONE
  hi Constant         ctermbg=NONE ctermfg=101  cterm=NONE        guibg=NONE    guifg=#999183 gui=NONE
  hi Boolean          ctermbg=NONE ctermfg=101  cterm=NONE        guibg=NONE    guifg=#999183 gui=NONE
  hi String           ctermbg=NONE ctermfg=101  cterm=NONE        guibg=NONE    guifg=#999183 gui=NONE
  ...
  hi IncSearch        ctermbg=178  ctermfg=238  cterm=NONE        guibg=#d5bc02 guifg=#3c4c55 gui=NONE
  hi Search           ctermbg=185  ctermfg=238  cterm=NONE        guibg=#ddd668 guifg=#3c4c55 gui=NONE
  ...
  hi WildMenu         ctermbg=252  ctermfg=238  cterm=NONE        guibg=#c5d4dd guifg=#3c4c55 gui=NONE
  hi ModeMsg          ctermbg=NONE ctermfg=72   cterm=NONE        guibg=NONE    guifg=#5bb899 gui=NONE

  hi DiffAdd          ctermbg=72   ctermfg=238  cterm=NONE        guibg=#5bb899 guifg=#3c4c55 gui=NONE
  hi DiffDelete       ctermbg=167  ctermfg=238  cterm=NONE        guibg=#db6c6c guifg=#3c4c55 gui=NONE
  hi DiffChange       ctermbg=238  ctermfg=178  cterm=UNDERLINE   guibg=#3c4c55 guifg=#d5bc02 gui=UNDERLINE
  hi DiffText         ctermbg=178  ctermfg=238  cterm=NONE        guibg=#d5bc02 guifg=#3c4c55 gui=NONE

  hi Pmenu            ctermbg=242  ctermfg=252  cterm=NONE        guibg=#616c72 guifg=#c5d4dd gui=NONE
  hi PmenuSel         ctermbg=238  ctermfg=252  cterm=REVERSE     guibg=#3c4c55 guifg=#c5d4dd gui=REVERSE
  ...
  hi TabLineSel       ctermbg=238  ctermfg=252  cterm=REVERSE     guibg=#3c4c55 guifg=#c5d4dd gui=REVERSE
  ...
  hi Todo             ctermbg=238  ctermfg=74   cterm=UNDERLINE   guibg=#3c4c55 guifg=#3ba2cc gui=UNDERLINE
